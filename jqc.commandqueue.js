...
skitsanos.utils.commands.AbstractCommand.Extends(skitsanos.utils.commands.ICommand);

skitsanos.utils.commands.AbstractCommand.prototype.execute = function() { /*not implemented */ };
skitsanos.utils.commands.AbstractCommand.onCommandComplete = function() {
...
//        for (prop in this._currentCommand) {
//            console.log(prop);
//        }
