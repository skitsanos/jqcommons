...
*/
EventDispatcher.prototype.getActionIdx = function(obj, evt, action, binding) {
    if (obj && evt) {
...
*/
EventDispatcher.prototype.addListener = function(obj, evt, action, binding) {
    if (this.events[obj]) {
...
* @return {null} Returns null.
*/
EventDispatcher.prototype.trigger = function(e, obj, evt, args) {
    if (!e) { e = window.event; }
